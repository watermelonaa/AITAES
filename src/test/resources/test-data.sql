...
-- 测试教师
INSERT INTO t_teacher (id, teacher_no, name, gender, college, department, title, email) VALUES
(1, 'T001', '张建国', '男', '计算机学院', '软件工程系', '教授', 'zjg@university.edu.cn'),
(2, 'T002', '李美玲', '女', '计算机学院', '网络工程系', '副教授', 'lml@university.edu.cn');

-- 测试学生
INSERT INTO t_student (id, student_no, name, gender, college, major, class_name, grade) VALUES
(1, 'S2024001', '赵小明', '男', '计算机学院', '软件工程', '软件2101', '2024'),
(2, 'S2024002', '钱小红', '女', '计算机学院', '软件工程', '软件2101', '2024'),
(3, 'S2024003', '孙大伟', '男', '计算机学院', '网络工程', '网络2101', '2024');
